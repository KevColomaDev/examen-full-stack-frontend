      ...
      <form className="max-w-2xl rounded-2xl" onSubmit={handleSubmit(onSubmit)}>
        <div className="bg-sky-100 p-4 max-w-2xl rounded-2xl">
          <div className="flex flex-row justify-center gap-2 font-bold sm:text-3xl mb-8 mt-8">
            ...
            <input type="number" id="toothPaste" placeholder="0" min={0} max={50} className="text-center w-10 sm:w-16 rounded-lg " {...register("toothPaste")}/>
          </div>
          <div className="flex flex-row justify-center gap-2 font-bold sm:text-3xl mb-8">
            ...
            <input type="number" id="soap" placeholder="0" min={0} max={50} className="text-center w-10 sm:w-16 rounded-lg " {...register("soap")}/>
          </div>
          <div className="flex flex-row justify-center gap-2 font-bold sm:text-3xl mb-8">
            <label htmlFor="toothBrush" className="w-32 sm:w-64 text-center">Cepillos</label>
            <input type="number" id="toothBrush" placeholder="0" min={0} max={50} className="text-center w-10 sm:w-16 rounded-lg " {...register("toothBrush")}/>
          </div>
          <div className="flex flex-row justify-center gap-2 font-bold sm:text-3xl mb-8">
            <label htmlFor="towel" className="w-32 sm:w-64 text-center">Toallas</label>
            <input type="number" id="towel" placeholder="0" min={0} max={50} className="text-center w-10 sm:w-16 rounded-lg " {...register("towel")}/>
          </div>
